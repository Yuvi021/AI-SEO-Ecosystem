...
export default function SignupPage() {
  ...
  if (authLoading || isAuthenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-slate-50 via-blue-50/30 to-indigo-50/20  dark:bg-gray-900 transition-colors duration-300 flex items-center justify-center">
        <motion.div
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-blue-50/30 to-indigo-50/20 dark:bg-black transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="fixed inset-0 bg-[linear-gradient(to_right,#3b82f612_1px,transparent_1px),linear-gradient(to_bottom,#3b82f612_1px,transparent_1px)] bg-[size:24px_24px]  dark:bg-gray-900 transition-colors duration-300 pointer-events-none z-0"></div>
