            ...
            {isAuthenticated ? (
              <>
                ...
                >
                  <Link
                    href="/results"
                    className={`p-2 rounded-lg font-medium hover:bg-gray-100 dark:hover:bg-gray-800 transition-all flex items-center justify-center ${
                      isActive('/results')
                        ? 'bg-gradient-to-r from-cyan-500 to-blue-600 text-white shadow-md'
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="p-2 text-gray-700 dark:text-gray-300 rounded-lg font-medium hover:bg-gray-100 dark:hover:bg-gray-800 transition-all flex items-center justify-center"
                  title="Sign Out"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
